           ...
           <div class="bloque-explicacion">
               ...
               <div class="ejemplos-grid">
                   <div class="ejemplo-card" style="border-left-color: var(--naranja);">
                       <div class="ejemplo-en"><strong>In</strong> (Dentro de / Áreas grandes / Países / Ciudades)</div>
                       <div class="ejemplo-es">In Spain (En España), In London (En Londres), In the room (En la habitación).</div>
                       <div class="ejemplo-pron">🗣️ /in espéin/ • /in lán-don/</div>
                   </div>
                   <div class="ejemplo-card" style="border-left-color: var(--naranja);">
                       <div class="ejemplo-en"><strong>On</strong> (Sobre superficies / Medios de transporte públicos)</div>
                       <div class="ejemplo-es">On the table (Sobre la mesa), On the bus (En el autobús), On the wall (En la pared).</div>
                       <div class="ejemplo-pron">🗣️ /on de téi-bel/ • /on de bas/</div>
                   </div>
                   <div class="ejemplo-card" style="border-left-color: var(--naranja);">
                       <div class="ejemplo-en"><strong>At</strong> (Sitios específicos / Lugares con función concreta)</div>
                       <div class="ejemplo-es">At school (En el colegio), At home (En casa), At the bus stop (En la parada).</div>
                       <div class="ejemplo-pron">🗣️ /at escúul/ • /at jóum/</div>
                   </div>
               </div>
           </div>
